...
from orientation.accelerometer import Accelerometer

class Accelerometer_ADXL343(Accelerometer):
	...
	def disable_inaction_detection(self) -> None:
		...
		active_interrupts &= ~_INT_INACT
		self.accelerometer._write_register_byte(_REG_INT_ENABLE, active_interrupts)
		self.accelerometer._enabled_interrupts.pop("inactivity", None)