...
from view_table_outline import ViewTableOutline, BLACK, RED

from utils.transition import CallbackTransitionFunction, SerialTransitionFunctions, NoOpTransition
